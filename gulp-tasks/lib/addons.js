...
gulp.task('blog', function() {
    ...
    return gulp.src('src/_blog/posts/*.md')
        .pipe(gulpFlatBlog({
            single: hbs.compile(fs.readFileSync('src/_blog/templates/single.hbs', 'utf8')),
            index: hbs.compile(fs.readFileSync('src/_blog/templates/index.hbs', 'utf8'))
        }))

        // .pipe(gulp.dest('dist/blog/posts'));
...
gulp.task('projects', function() {
    ...
    return gulp.src('src/_projects/posts/*.md')
        .pipe(gulpFlatBlog({
            single: hbs.compile(fs.readFileSync('src/_projects/templates/single.hbs', 'utf8')),
            index: hbs.compile(fs.readFileSync('src/_projects/templates/index.hbs', 'utf8'))
        }))
        // .pipe(gulp.dest('dist/blog/posts'));
